...
<div class="menuBoxInner masterFileIcon">
	...
	<div class="sub_section">
      ...
      <a href="<?php echo MWB; ?>master_file/place.php" class="headerText2"><?php echo __('Place List'); ?></a>
      <a href="<?php echo MWB; ?>master_file/place.php?action=detail" class="headerText2"><?php echo __('Add New Place'); ?></a>
	  </div>
