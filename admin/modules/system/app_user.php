...
<div class="menuBoxInner userIcon">
	...
	<div class="sub_section">
      ...
      <a href="<?php echo MWB; ?>/system/app_user.php" class="headerText2"><?php echo __('User List'); ?></a>
      <a href="<?php echo MWB; ?>system/app_user.php?action=detail" class="headerText2"><?php echo __('Add New User'); ?></a>
	  </div>
